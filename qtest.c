...
//             // TODO: Error message could be better by separating these two
//             cases printf("Invalid operation\n"); x = y = 0; break;
//         }
//         x -= 1;
//         y -= 1;
//     }
...
static void console_init()
{
    ...
    ADD_COMMAND(ttt,
                "tic-tac-toe, Switch between Human vs. Computer(hc) or "
                "Computer vs. Computer(cc) gameplay.",
                "[mode]");
